...
<?php require_once('inc\steel-header.php');?>
    ...
    if(isset($_POST["submit"]))
      {
$name=$_POST["orderid"];
$sql="select orderdetail from orderdetails where orderid='".$name."'";
